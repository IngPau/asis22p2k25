...
namespace Capa_Vista_Navegador
{
    public partial class Navegador : UserControl
    {
        ...
        {
            Help.ShowHelp(this, "AyudaRisko/AyudaRiskoCAP.chm", "MDI.html");
        }

        private void Btn_imprimir_Click_1(object sender, EventArgs e)
        {
            // Crear instancia del formulario Frm_Reportes
            Frm_Reportes frm = new Frm_Reportes();

            // Opción 1: Mostrar el formulario como ventana independiente
            frm.Show();
